...
public interface ChatRoomRepository extends JpaRepository<ChatRoom, Long> {
    ...
    @Query("SELECT cr FROM ChatRoom cr JOIN FETCH cr.sender crs JOIN FETCH cr.receiver crr WHERE crs.username = :username " +
            "OR crr.username = :username ORDER BY cr.id desc")
